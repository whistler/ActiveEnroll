...
public class MailGradesController1 implements Initializable {
 ...
 */
    ...
    private void mailInstructions() throws MessagingException, InterruptedException, SQLException {
        ...
        try {
            ...
            Logger.getLogger(com.mss.tuess.controllers.MailGradesController1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
